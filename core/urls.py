...
urlpatterns = [
    ...
    path('payment-cash/', cashPay, name='payment-cash'),
    path('request-refund/', RequestRefundView.as_view(), name='request-refund'),
    path('panel/', AdminIndex.as_view(), name='panel-index'),
    path('panel/orders', adminorderlist, name='panel-order'),
    path('panel/order-detail/<int:oid>/',
         orderDetail, name='panel-order-detail'),
    path('panel/order-delete/<int:oid>/',
         deleteOrder, name='panel-order-delete'),
    path('panel/order-conf/<int:oid>/',
         confOrder, name='panel-order-conf'),
    path('panel/order-receive/<int:oid>/',
         recieveOrder, name='panel-order-receive'),
